...
const database_test_1 = __importDefault(require("./modules/commands/database test"));
...
const commands = new gears_discordjs_1.CommandGroupBuilder()
    ...
    .setCommands(say_1.default, meme_1.default, joke_1.default, database_test_1.default)
    .done();
...
constants_1.app.listen(constants_1.port, init);
